		...
		function show() {
			call('api/seminar/details/' + seminar_id).done(function(res) {
				if (res.error == true) {
                    ...
                    $('.tanggal_jam').html(function() {
                        // Cek apakah salah satu data tidak ada
                        if (!res.data.tanggal || !res.data.jam_mulai || !res.data.jam_selesai) {
                            return 'Belum ada data';
                        }
                        // Format data jika semuanya tersedia
                        return res.data.tanggal + ' ' + res.data.jam_mulai + ' - ' + res.data.jam_selesai;
                    });
