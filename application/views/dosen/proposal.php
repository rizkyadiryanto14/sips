        ...
        function show() {
            ...
            $('#data-proposal').DataTable({
                ...
                "ajax": {
                    ...
                    "method": "POST",
                    "data": function(d) {
                        // Mengirim kedua kondisi ke server
                        d.dosen_id = '<?= $this->session->userdata('id') ?>';
                        d.dosen2_id = '<?= $this->session->userdata('id') ?>'; // Ambil nilai dosen2_id dari elemen input lain, jika ada
                    },
                    "dataSrc": "data"
                },
                "columns": [{
