            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="nim" type="text" name="nim" autocomplete="off" autofocus="true" class="form-control" placeholder="Masukkan NIM (tanpa titik )" maxlength="11">
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        $("#nim").keyup(function() {
            if ($(this).val().length == 11) {
                ...
                notif('Silahkan masukkan maksimal 11 digit', 'info', true);
                $(".btn-act").attr('disabled', true);
            }
        });
